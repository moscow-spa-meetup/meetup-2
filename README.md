...
Слайды: [PDF](pdf/make-life-easy.pdf)
...
Слайды: [HTML](http://www.slideshare.net/negoryacheva/avito-spa-meetup-2-61405477), [PDF](pdf/mri-for-data.pdf)
...
Слайды: [PDF](pdf/server-side-rendering.pdf)
...
Слайды: [HTML](http://www.slideshare.net/basisjs/csso-css-2), [PDF](pdf/csso2.pdf)
